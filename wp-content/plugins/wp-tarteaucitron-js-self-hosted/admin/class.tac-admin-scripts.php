...
class Tac_admin_scripts
{
    public static function register_settings()
    {
      ...
      # Analytics settings
      register_setting('tac_admin_analytic_settings', 'tac_header_script_content');

      add_settings_section('tac_admin_analytic_section', 'Tarteaucitron.js parameters', array('Tac_admin_scripts', 'section_html'), 'tac_admin_analytic_settings');

      register_setting('tac_admin_script_settings', "tac_init_sendDomaine");
      $args1 = array('id' => "tac_init_sendDomaine", 'value' => "true", "comment" => "Send only the domaine name to know exactly how many time the plugin is used.", "options" => ['true', 'false']);
      add_settings_field("tac_init_sendDomaine", "Share domaine name", array("Tac_admin_scripts", "script_options_html"), 'tac_admin_analytic_settings', "tac_admin_analytic_section", $args1);
    ...
    public static function header_content_html()
    {
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <p>If a settings ins't in the above options but are already present in the script tarteaucitron.js, you can put the code here. (Only for the initialisation script).</p>
            </div>
        </div>
        <?php
    }
