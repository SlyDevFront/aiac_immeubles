...
//        if(get_option("tac_init_sendDomaine", true)){
//            add_action('wp_enqueue_scripts', array('Tac_frontend', 'HomeAnalitics'));
//        }
    }

//    public static function HomeAnalitics(){
//        wp_enqueue_script('tarteaucitronjsCustom', plugin_dir_url(__FILE__) . 'js/mainStat.js', array(), '1.0');
//
//    }

    public static function customHeaderScript()
    {
        wp_enqueue_script('tarteaucitronjshead', plugin_dir_url(__FILE__) . 'js/tarteaucitron/tarteaucitron.js', array(), '1.0');

        wp_enqueue_script('tarteaucitronjsheadmain', plugin_dir_url(__FILE__) . 'js/main.js', array(), '1.0');
    ...
    public static function customFooterScript()
    {
        ...
        wp_enqueue_script('tarteaucitronjsfootmain', plugin_dir_url(__FILE__) . 'js/main.js', array(), '1.0');
