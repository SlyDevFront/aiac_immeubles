        ...
        echo '<div class="wrap">
	       	<form method="post" action="">
                <div class="tarteaucitronDiv" style="margin-bottom:25px;background: #ffe;text-align: center;margin-top: 27px;">
                   <p style="font-size: 16px;">'.__('Get the ID and Token on the "My account" tab', 'tarteaucitronjs').'<br/><b><a href="https://opt-out.ferank.eu/fr/pro/login/" target="_blank">'.__("View my account", 'tarteaucitronjs').'</a></b></p>
                </div>
